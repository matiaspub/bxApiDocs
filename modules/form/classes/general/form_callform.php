...
class CAllForm extends CForm_old
{
	 ...
	 *
	 *
	 * @param array &$columns  Массив, описывающий те вопросы и поля формы, которые: <ol> <li>
	 * активны;</li> <li>включены в таблицу результатов.</li> </ol> Ключами
	 * данного массива являются ID вопросов/полей, а значениями - массив,
	 * описывающий сам вопрос/поле, в свою очередь, имеющий следующие
	 * ключи: <ul> <li> <b>ID</b> - ID вопроса/поля; </li> <li> <b>FORM_ID</b> - ID формы; </li> <li>
	 * <b>TIMESTAMP_X</b> - дата изменения вопроса/поля; </li> <li> <b>ACTIVE</b> - флаг
	 * активности [Y|N]; </li> <li> <b>TITLE</b> - текст вопроса, либо заголовок поля;
	 * </li> <li> <b>TITLE_TYPE</b> - тип текста; </li> <li> <b>SID</b> - символьный
	 * идентификатор вопроса/поля; </li> <li> <b>C_SORT</b> - порядок сортировки;
	 * </li> <li> <b>ADDITIONAL</b> - если Y - то данная запись является вопросом; если N
	 * - то полем формы; </li> <li> <b>REQUIRED</b> - флаг обязательности ответа на
	 * вопрос [Y|N]; </li> <li> <b>IN_FILTER</b> - флаг показывающий отражен ли
	 * вопрос/поле в фильтре формы результатов [Y|N]; </li> <li> <b>IN_RESULTS_TABLE</b> -
	 * флаг показывающий отображается ли вопрос/поле в таблице
	 * результатов [Y|N]; </li> <li> <b>IN_EXCEL_TABLE</b> - флаг показывающий
	 * отображается ли вопрос/поле в Excel-таблице результатов [Y|N]; </li> <li>
	 * <b>FIELD_TYPE</b> тип поля, возможны следующие значения: <ul> <li> <b>text</b> -
	 * текст; </li> <li> <b>integer</b> - число; </li> <li> <b>date</b> - дата. </li> </ul> </li> <li>
	 * <b>IMAGE_ID</b> - ID изображения в описании вопроса; </li> <li> <b>COMMENTS</b> -
	 * служебный комментарий; </li> <li> <b>FILTER_TITLE</b> - заголовок поля фильтра
	 * по данному вопросу/полю; </li> <li> <b>RESULTS_TABLE_TITLE</b> - заголовок столбца
	 * таблицы результатов. </li> </ul> <b>Пример:</b> <pre style="height:450px">Array ( [140] =&gt;
	 * Array ( [ID] =&gt; 140 [FORM_ID] =&gt; 4 [TIMESTAMP_X] =&gt; 19.05.2005 11:42:04 [ACTIVE] =&gt; Y [TITLE] =&gt;
	 * Фамилия, имя, отчество [TITLE_TYPE] =&gt; html [SID] =&gt; VS_NAME [C_SORT] =&gt; 100 [ADDITIONAL]
	 * =&gt; N [REQUIRED] =&gt; Y [IN_FILTER] =&gt; Y [IN_RESULTS_TABLE] =&gt; N [IN_EXCEL_TABLE] =&gt; N [FIELD_TYPE] =&gt;
	 * [IMAGE_ID] =&gt; [COMMENTS] =&gt; [FILTER_TITLE] =&gt; [RESULTS_TABLE_TITLE] =&gt; ) [144] =&gt; Array ( [ID] =&gt; 144
	 * [FORM_ID] =&gt; 4 [TIMESTAMP_X] =&gt; 11.11.2004 18:11:21 [ACTIVE] =&gt; Y [TITLE] =&gt; Какие области
	 * знаний вас интересуют ? [TITLE_TYPE] =&gt; text [SID] =&gt; VS_INTEREST [C_SORT] =&gt; 500
	 * [ADDITIONAL] =&gt; N [REQUIRED] =&gt; N [IN_FILTER] =&gt; Y [IN_RESULTS_TABLE] =&gt; Y [IN_EXCEL_TABLE] =&gt; Y
	 * [FIELD_TYPE] =&gt; [IMAGE_ID] =&gt; [COMMENTS] =&gt; [FILTER_TITLE] =&gt; [RESULTS_TABLE_TITLE] =&gt; ) ... ) </pre>
	 *
	 *
	 *
	 * @param array &$answers  Массив, содержащий ответы на вопросы формы, а также значения
	 * полей формы. Ключами данного массива являются: <ul> <li> <b>RESULT_ID</b> - ID
	 * результата; </li> <li> <b>FIELD_ID</b> - ID вопроса/поля; </li> <li> <b>SID</b> -
	 * символьный идентификатор вопроса/поля; </li> <li> <b>TITLE</b> - текст
	 * вопроса или заголовок поля веб-формы; </li> <li> <b>TITLE_TYPE</b> - тип текста
	 * вопроса, допустимы следующие значения: <ul> <li> <b>text</b> - текст; </li> <li>
	 * <b>html</b> - HTML код. </li> </ul> </li> <li> <b>FILTER_TITLE</b> - подпись поля фильтра по
	 * данному вопросу/полю; </li> <li> <b>RESULTS_TABLE_TITLE</b> - подпись столбца
	 * таблицы результатов; </li> <li> <b>ANSWER_ID</b> - ID ответа; </li> <li> <b>ANSWER_TEXT</b> -
	 * параметр ответа <font color="green">ANSWER_TEXT</font>, записанный в таблицу
	 * результата; </li> <li> <b>MESSAGE</b> - параметр ответа <font color="green">ANSWER_TEXT</font>,
	 * хранящийся в таблице ответов (синоним ключа <b>ANSWER_TEXT</b>); </li> <li>
	 * <b>ANSWER_VALUE</b> - параметр ответа <font color="red">ANSWER_VALUE</font>, записанный в
	 * таблицу результата; </li> <li> <b>VALUE</b> - параметр ответа <font
	 * color="red">ANSWER_VALUE</font>, хранящийся в таблице ответов (синоним ключа
	 * <b>ANSWER_VALUE</b>); </li> <li> <b>USER_TEXT</b> - текстовое значение, введенное
	 * пользователем; </li> <li> <b>USER_DATE</b> - дата, введенная пользователем
	 * (данный ключ может содержать значение, только если <b>FIELD_TYPE</b>="date");
	 * </li> <li> <b>USER_FILE_ID</b> - ID файла загруженного пользователем (данный
	 * ключ может содержать значение, только если <b>FIELD_TYPE</b>="image" или
	 * <b>FIELD_TYPE</b>="file"); </li> <li> <b>USER_FILE_NAME</b> - оригинальное имя загруженного
	 * файла (данный ключ может содержать значение, только если
	 * <b>FIELD_TYPE</b>="image" или <b>FIELD_TYPE</b>="file"); </li> <li> <b>USER_FILE_IS_IMAGE</b> - "Y" - если
	 * <b>FIELD_TYPE</b>="image", "N" - если <b>FIELD_TYPE</b>="file" </li> <li> <b>USER_FILE_HASH</b> -
	 * уникальный хеш, используемый при показе файла (данный ключ может
	 * содержать значение, только если <b>FIELD_TYPE</b>="file"); </li> <li> <b>USER_FILE_SUFFIX</b>
	 * - суффикс к расширению загруженного файла (данный ключ может
	 * содержать значение, только если <b>FIELD_TYPE</b>="file"); </li> <li> <b>USER_FILE_SIZE</b> -
	 * размер файла в байтах (данный ключ может содержать значение,
	 * только если <b>FIELD_TYPE</b>="image" или <b>FIELD_TYPE</b>="file"); </li> <li> <b>FIELD_TYPE</b> - тип
	 * поля ответа, возможны следующие значения: <ul> <li> <b>text</b> -
	 * однострочное текстовое поле; </li> <li> <b>textarea</b> - многострочное
	 * текстовое поле; </li> <li> <b>radio</b> - переключатель одиночного выбора;
	 * </li> <li> <b>checkbox</b> - флаг множественного выбора; </li> <li> <b>dropdown</b> -
	 * элемента выпадающего списка одиночного выбора; </li> <li> <b>multiselect</b> -
	 * элемента списка множественного выбора; </li> <li> <b>date</b> - поле для
	 * ввода дата в календарем; </li> <li> <b>image</b> - поле для ввода
	 * изображения; </li> <li> <b>file</b> - поле для ввода произвольного файла; </li>
	 * <li> <b>password</b> - однострочное поле для ввода пароля. </li> </ul> </li> <li>
	 * <b>FIELD_WIDTH</b> - ширина поля ответа; </li> <li> <b>FIELD_HEIGHT</b> - высота поля
	 * ответа; </li> <li> <b>FIELD_PARAM</b> - параметры поля ответа. </li> </ul> <b>Пример:</b>
	 * <pre style="height:450px"> Array ( [186] =&gt; Array ( [140] =&gt; Array ( [586] =&gt; Array ( [RESULT_ID] =&gt; 186
	 ...
	 *
	 *
	 * @param array &$answers2 = array() Массив, содержащий, по сути, те же данные, что и массив <i>answers</i>, но
	 * имеющий несколько другую структуру. <br><br><b>Пример:</b> <pre
	 * style="height:450px"> Array ( [186] =&gt; Array ( [VS_NAME] =&gt; Array ( [0] =&gt; Array ( [RESULT_ID] =&gt; 186
	 * [FIELD_ID] =&gt; 140 [SID] =&gt; VS_NAME [TITLE] =&gt; Фамилия, имя, отчество [TITLE_TYPE] =&gt; html
	 * [FILTER_TITLE] =&gt; [RESULTS_TABLE_TITLE] =&gt; [ANSWER_ID] =&gt; 586 [ANSWER_TEXT] =&gt; [MESSAGE] =&gt;
	 * [ANSWER_VALUE] =&gt; [VALUE] =&gt; [USER_TEXT] =&gt; Иванов Дмитрий Витальевич [USER_DATE] =&gt;
	 * [USER_FILE_ID] =&gt; [USER_FILE_NAME] =&gt; [USER_FILE_IS_IMAGE] =&gt; [USER_FILE_HASH] =&gt; [USER_FILE_SUFFIX] =&gt;
	 * [USER_FILE_SIZE] =&gt; [FIELD_TYPE] =&gt; text [FIELD_WIDTH] =&gt; 50 [FIELD_HEIGHT] =&gt; 0 [FIELD_PARAM] =&gt; ) )
	 * [VS_INTEREST] =&gt; Array ( [0] =&gt; Array ( [RESULT_ID] =&gt; 186 [FIELD_ID] =&gt; 144 [SID] =&gt; VS_INTEREST [TITLE]
	 * =&gt; Какие области знаний вас интересуют ? [TITLE_TYPE] =&gt; text [FILTER_TITLE] =&gt;
	 * [RESULTS_TABLE_TITLE] =&gt; [ANSWER_ID] =&gt; 594 [ANSWER_TEXT] =&gt; иностранные языки [MESSAGE] =&gt;
	 * иностранные языки [ANSWER_VALUE] =&gt; 4 [VALUE] =&gt; 4 [USER_TEXT] =&gt; [USER_DATE] =&gt;
	 * [USER_FILE_ID] =&gt; [USER_FILE_NAME] =&gt; [USER_FILE_IS_IMAGE] =&gt; [USER_FILE_HASH] =&gt; [USER_FILE_SUFFIX] =&gt;
	 * [USER_FILE_SIZE] =&gt; [FIELD_TYPE] =&gt; checkbox [FIELD_WIDTH] =&gt; 0 [FIELD_HEIGHT] =&gt; 0 [FIELD_PARAM] =&gt; )
	 * [1] =&gt; Array ( [RESULT_ID] =&gt; 186 [FIELD_ID] =&gt; 144 [SID] =&gt; VS_INTEREST [TITLE] =&gt; Какие
	 * области знаний вас интересуют ? [TITLE_TYPE] =&gt; text [FILTER_TITLE] =&gt;
	 * [RESULTS_TABLE_TITLE] =&gt; [ANSWER_ID] =&gt; 595 [ANSWER_TEXT] =&gt; програмирование [MESSAGE] =&gt;
	 * програмирование [ANSWER_VALUE] =&gt; 5 [VALUE] =&gt; 5 [USER_TEXT] =&gt; [USER_DATE] =&gt; [USER_FILE_ID]
	 * =&gt; [USER_FILE_NAME] =&gt; [USER_FILE_IS_IMAGE] =&gt; [USER_FILE_HASH] =&gt; [USER_FILE_SUFFIX] =&gt; [USER_FILE_SIZE]
	 ...
	 *
	 *
	 * @param array $filter = array() Массив для фильтрации выбираемых значений. В массиве допустимы
	 * следующие ключи: <ul> <li> <b>RESULT_ID</b>* - ID результата (по умолчанию будет
	 * искаться точное совпадение); </li> <li>RESULT_ID_EXACT_MATCH - если значение
	 * равно "N", то при фильтрации по <b>RESULT_ID</b> будет искаться вхождение;
	 * </li> <li> <b>FIELD_ID</b>* - ID вопроса/поля (по умолчанию будет искаться
	 * точное совпадение); </li> <li> <b>FIELD_ID_EXACT_MATCH</b> - если значение равно "N",
	 * то при фильтрации по <b>FIELD_ID</b> будет искаться вхождение; </li> <li>
	 * <b>FIELD_SID</b>* - символьный код вопроса/поля (по умолчанию будет
	 * искаться вхождение); </li> <li> <b>FIELD_SID_EXACT_MATCH</b> - если значение равно
	 * "Y", то при фильтрации по <b>FIELD_SID</b> будет искаться точное
	 * совпадение; </li> <li> <b>IN_RESULTS_TABLE</b> - если значение равно "Y", то ответы
	 * на вопрос (либо значения поля веб-формы) будет отображены в
	 * таблице результатов; </li> <li> <b>IN_EXCEL_TABLE</b> - если значение равно "Y", то
	 * ответы на вопрос (либо значения поля веб-формы) будет отображены в
	 * Excel таблице результатов. </li> </ul> * - допускается сложная логика.
	 *
	 *
	 *
	 * @return mixed 
	 ...
	 *
	 *
	 * @param string $get_fields = "Y" Если значение данного параметра равно "Y", то в массиве
	 * <i>questions</i>будут представлены только поля формы.<br> Если значение
	 * равно "" - вопросы и поля формы.<br> В остальных случаях - в массиве
	 * <i>questions</i>будут описаны только вопросы формы.<br><br> Параметр
	 * необязательный. По умолчанию - "N" (не добавлять в массив
	 * <i>questions</i>данные о полях веб-формы).
	 *
	 *
	 *
	 * @return mixed 
	...
	/**
	 * <p>Функция проверяет введенные значения на обязательность, правильность формата даты и правильность типа файла. При необходимости проверяются права текущего пользователя. В случае неудачи - возвращает текст ошибки.</p>
	 *
	 *
	 *
	 *
	 ...
	 *
	 *
	 * @param int $result_id = false Если данная функция вызывается для проверки полей при
	 ...
	 * успешной проверки прав, производимой данной функцией,
	 ...
	 *
	 *
	 * @param string $return_array = "N" Если данный параметр не установлен или равен "N", то функция
	 * возвращает отформатированный список ошибок.<br> Если же
	 * установлен в "Y", то функция возвращает массив, в котором сообщения
	 ...
	 * 
	 * // если функция не вернула текст ошибки, то
	 * if (strlen($error)&lt;=0) 
	 * {
	 *     // обновляем результат
