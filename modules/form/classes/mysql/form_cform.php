...
class CForm extends CAllForm
{
	...
	/**
	* <p>Возвращает список <a href="http://dev.1c-bitrix.ru/api_help/form/terms.php#form">веб-форм</a> в виде объекта класса <a href="http://dev.1c-bitrix.ru/api_help/main/reference/cdbresult/index.php">CDBResult</a>. Метод нестатический.</p>
	*
	*
	...
	* убыванию. </li> </ul>
	*
	* @param array $filter = array() Массив для фильтрации. В массиве допустимы следующие ключи: 		<ul>
	* <li> <b>ID</b>* - ID веб-формы (по умолчанию будет искаться точное
	...
	* точное совпадение); 			</li> <li> <b>SID_EXACT_MATCH</b> - если значение равно "N",
	* то при фильтрации по <b>SID</b> будет искаться вхождение; 			</li> <li>
	* <b>NAME</b>* - заголовок веб-формы (по умолчанию будет искаться
	* вхождение); 			</li> <li> <b>NAME_EXACT_MATCH</b> - если значение равно "Y", то при
	* фильтрации по <b>NAME</b> будет искаться точное совпадение; 			</li> <li>
	* <b>DESCRIPTION</b>* - описание веб-формы (по умолчанию будет искаться
	* вхождение); 			</li> <li> <b>DESCRIPTION_EXACT_MATCH</b> - если значение равно "Y", то
	* при фильтрации по <b>DESCRIPTION</b> будет искаться точное совпадение;
	* 			</li> <li> <b>SITE</b>* - идентификатор сайта или массив идентификаторов
	* сайтов, к которым приписана веб-форма (по умолчанию будет
	* искаться точное совпадение); 			</li> <li> <b>SITE_EXACT_MATCH</b> - если значение
	* равно "N", то при фильтрации по <b>SITE</b> будет искаться вхождение. </li>
	* </ul> 		* - допускается сложная логика
	*
