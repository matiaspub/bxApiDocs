...
class CAllForumPoints
{
	 ...
	 *
	 * @static
	 * @link http://dev.1c-bitrix.ru/api_help/forum/developer/cforumpoints/cforumpoints__delete.c1162eae.php
	 * @author Bitrix
	 */
	 ...
	 * звания для сортировки:<br> ID - код звания<br> CODE - мнемонический код<br>
	 * VOTES - количество голосов при голосовании<br> MIN_POINTS - количество
	 ...
	 * <p>Допустимые параметры звания для фильтрации:<br> ID - код звания<br>
	 * CODE - мнемонический код<br> MIN_POINTS - количество баллов, которые нужны
	 ...
	 *
	 * @static
	 * @link http://dev.1c-bitrix.ru/api_help/forum/developer/cforumpoints/cforumpoints__getlist.e41a048e.php
	 * @author Bitrix
	 */
	 ...
	 * ассоциативный массив, в котором ключами являются названия
	 * параметров звания, а значениями - условия на эти параметры.</p>
	 * <p>Допустимые параметры звания для фильтрации:<br> LID - код языка
	 * (должен присутствовать в фильтре) <br> ID - код звания<br> CODE -
	 * мнемонический код<br> MIN_POINTS - количество баллов, которые нужны для
	 * достижения этого звания.</p>
	 *
	 *
	 *
	 ...
	 *
	 * @static
	 * @link http://dev.1c-bitrix.ru/api_help/forum/developer/cforumpoints/cforumpoints__getlistex.88520fc4.php
	 * @author Bitrix
	 */
	 ...
	 *
	 * @static
	 * @link http://dev.1c-bitrix.ru/api_help/forum/developer/cforumpoints/cforumpoints__getbyid.a6fa5a0a.php
	 * @author Bitrix
	 */
	 ...
	 *
	 * @static
	 * @link http://dev.1c-bitrix.ru/api_help/forum/developer/cforumpoints/cforumpoints__getbyidex.9a2a2c3c.php
	 * @author Bitrix
	 */
	 ...
	 *
	 * @static
	 * @link http://dev.1c-bitrix.ru/api_help/forum/developer/cforumpoints/cforumpoints__getlangbyid.e7dc3833.php
	 * @author Bitrix
	 */
...
class CAllForumPoints2Post
{
	 ...
	 *
	 *
	 * @return bool <p>Функция возвращает значение True.</p>
	 *
	 * @static
	 * @link http://dev.1c-bitrix.ru/api_help/forum/developer/cforumpoints2post/cforumpoints2post__delete.cd765c4a.php
	 * @author Bitrix
	 */
	public static function Delete($ID)
	{
	 ...
	 * значениями - направления сортировки.</p> <p>Допустимые параметры
	 * записи для сортировки: <br> ID - код записи <br> MIN_NUM_POSTS - количество
	 * сообщений, которое пользователь должен написать на форуме для
	 * получения этого количества балов за одно сообщение <br> POINTS_PER_POST -
	 * Количество балов за одно сообщение <br></p>
	 *
	 *
	 *
	 ...
	 * <p>Допустимые параметры записи для фильтрации: <br> ID - код записи <br>
	 * MIN_NUM_POSTS - количество сообщений, которое пользователь должен
	 ...
	 * сообщение.</td> </tr> </tbody></table>
	 *
	 * @static
	 * @link http://dev.1c-bitrix.ru/api_help/forum/developer/cforumpoints2post/cforumpoints2post__getlist.85ee73ee.php
	 * @author Bitrix
	 */
	 ...
	 * одна десятая бала за каждое сообщение.</td> </tr> </tbody></table>
	 *
	 * @static
	 * @link http://dev.1c-bitrix.ru/api_help/forum/developer/cforumpoints2post/cforumpoints2post__getbyid.84b865bd.php
	 * @author Bitrix
	 */
	public static function GetByID($ID)
	{
...
class CAllForumUserPoints
{
	 ...
	 *
	 * @static
	 * @link http://dev.1c-bitrix.ru/api_help/forum/developer/cforumuserpoints/cforumuserpoints__getbyid.b7364e85.php
	 * @author Bitrix
	 */
