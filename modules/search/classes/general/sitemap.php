...
class CAllSiteMap extends CDBResult
{
	...
	/**
	* <p>Создание карты сайта в формате Google Sitemap.</p>   <p>Создание всегда происходит в пошаговом режиме. Нестатический метод.</p>
	*
	*
	...
	*
	* @param array $arrayNS  Начало шага. Передается результат, возвращенный предыдущим
