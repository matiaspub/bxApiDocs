...
class _CEventsSearch {
	/**
	 * <p>Событие "BeforeIndex" вызывается перед индексацией элемента функцией <a href="http://dev.1c-bitrix.ru/api_help/search/classes/csearch/indexs.php">CSearch::Index</a>.</p>
	 *
	 *
	 *
	 *
	...
	/**
	 * <p>Событие "OnSearch" вызывается перед выполнением поисковых запросов функцией <a href="http://dev.1c-bitrix.ru/api_help/search/classes/csearch/search.php">CSearch::Search</a>.</p>
	 *
	 *
	 *
	 *
	...
	/**
	 * <p>Событие "OnReindex" вызывается во время переиндексации данных модуля функциями <a href="http://dev.1c-bitrix.ru/api_help/search/classes/csearch/reindexmodule.php">CSearch::ReindexModule</a> или <a href="http://dev.1c-bitrix.ru/api_help/search/classes/csearch/reindexall.php">CSearch::ReIndexAll</a>.</p>
	 *
	 *
	 *
	 *
