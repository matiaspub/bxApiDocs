 ...
 * идентификатор модуля (не изменится);</li>          			           <li> <b>ITEM_ID</b> -
 * идентификатор элемента (не изменится);</li>          			           <li> <b>PARAM1</b> -
 * первый параметр элемента;</li>          			           <li> <b>PARAM2</b> - второй
 * параметр элемента;</li>          			           <li> <b>DATE_FROM</b> - дата начала
 * активности элемента;</li>          			           <li> <b>DATE_TO</b> - дата окончания
 * активности элемента;</li>          			           <li> <b>TITLE</b> - заголовок;</li>         
 * 			           <li> <b>BODY</b> - содержание;</li>          			           <li> <b>TAGS</b> - теги
 * элемента;</li>          			           <li> <b>SITE_ID</b> - массив сайтов;</li>          			        
 *   <li> <b>PERMISSIONS</b> - массив идентификаторов групп пользователей
 * которым разрешено чтение;</li>          			           <li> <b>URL</b> - адрес
 ...
 * }
 * Смотрите также<li><a href="https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=43&amp;LESSON_ID=5196">Как ограничить область поиска разделом инфоблока</a></li>
 * </pre>
 *
 *
 * <h4>See Also</h4> 
 ...
 *
 *
 * @param array $arrayNS  Массив в котором передается информация о начале текущего шага. 		  
 *       <ul> <li> <b>MODULE</b> - идентификатор модуля;</li>          			           <li> <b>ID</b> -
 * идентификатор элемента;</li>          			           <li> <b>SITE_ID</b> - массив
 * сайтов;</li>          		</ul>
 *
 ...
 * <h4>See Also</h4> 
 * <ul> <li><a
 * href="http://dev.1c-bitrix.ru/api_help/search/classes/csearch/reindexmodule.php">CSearch::ReindexModule</a></li>  	  
 * <li><a href="http://dev.1c-bitrix.ru/api_help/search/classes/csearch/reindexall.php">CSearch::ReIndexAll</a></li>  	  
 ...
 * @author Bitrix
 */
	public static function OnReIndex($arrayNS, $oCallback, $callback_method){}
 ...
 * содержимое документа;</li>  	    <li> <b>PROPERTIES</b> - массив свойств
 * документа (обязательное). Если свойств нет, то должен быть передан
 * пустой массив. Содержимое элемента этого массива с именем
 * указанным в настройках модуля как "Код свойства страницы в
 * котором хранятся теги" будет занесен в теги;</li>  </ul><p>Или может
 * вернуть false, если не знает как файл должен быть обработан.</p>
 *
 * <h4>Example</h4> 
 * <pre bgcolor="#323232" style="padding:5px;">
 ...
 *
 * <h4>See Also</h4> 
 * <ul> <li><a href="http://dev.1c-bitrix.ru/api_help/search/functions/tags_prepare.php">Tags_prepare</a></li>  	 	   
 * <li><a href="http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=43&amp;LESSON_ID=3493" >Обработка
 * событий</a></li>  </ul><a name="examples"></a>
 *
 *
 ...
 *
 *
 * @param mixed $intID  Уникальный идентификатор записи в поисковом индексе.         <br>
 *
 ...
 * @author Bitrix
 */
	public static function OnBeforeIndexUpdate($intID, $arFields){}
 ...
 * @author Bitrix
 */
	public static function OnAfterIndexAdd($intID, $arFields){}
