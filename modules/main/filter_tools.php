...
/**
 * <p>Инициализирует, либо запоминает переменные фильтра в сессии.</p> <p class="note">Функция работает с переменными из глобальной области видимости, это необходимо учитывать при <a href="https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=43&amp;LESSON_ID=2818" >создании основных файлов компонентов</a>.</p>
 *
 *
 *
 *
