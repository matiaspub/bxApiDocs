...
class CMainPage
{
	...
	/**
	 * <p>Возвращает идентификатор [link=89624]сайта[/link], определяя его по текущему хосту. Если идентификатор сайта неверный, то вернет - "false".</p>
	 *
	 *
	 *
	 *
	...
	/**
	 * <p>Перенаправляет на индексную страницу [link=89624]сайта[/link].</p>
	 *
	 *
	 *
	 *
