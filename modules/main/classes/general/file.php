...
class CAllFile
{
	 ...
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/cfile/inputfile.php">CFile::InputFile</a> </li> </ul><a
	 * name="examples"></a>
	 *
	 *
	 * @static
...
function ImgShw(ID, width, height, alt)
{
	 ...
	 * прямоугольник <i>$arSize</i> без сохранения пропорций;</li> <li>
	 ...
	 * <i>$arSize</i>, улучшенна обработка вертикальных картинок.</li> </ul>
	 *
	 *
	 *
