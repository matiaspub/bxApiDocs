...
class CAllOption
{
	 ...
	 * Необязательный. По умолчанию - <i>false</i> (значение записывается на
	 * текущий сайт). Если нужно установить общий для всех сайтов
	 * параметр, то используйте пустую строку.
	 *
	 *
	 *
	 * @return bool 
