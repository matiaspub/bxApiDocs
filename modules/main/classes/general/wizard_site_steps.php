...
class CPackageWelcome extends CWizardStep
{
	...
	public static function CPackageWelcome($package)
	{
...
class CPackageLicense extends CWizardStep
{
	...
	public static function CPackageLicense($package)
	{
		$this->package = $package;
		parent::CWizardStep();
	}
...
class CPackageSelectSite extends CWizardStep
{
	...
	public static function CPackageSelectSite($package)
	{
		$this->package = $package;
		parent::CWizardStep();
	}
...
class CPackageSelectGroup extends CWizardStep
{
	...
	public static function CPackageSelectGroup($package)
	{
		$this->package = $package;
		parent::CWizardStep();
	}
...
class CPackageSelectTemplate extends CWizardStep
{
	...
	public static function CPackageSelectTemplate($package)
	{
		$this->package = $package;
		parent::CWizardStep();
	}
...
class CPackageSelectService extends CWizardStep
{
	...
	public static function CPackageSelectService($package)
	{
		$this->package = $package;
		parent::CWizardStep();
	}
...
class CPackageSelectStructure extends CWizardStep
{
	...
	public static function CPackageSelectStructure($package)
	{
		$this->package = $package;
		parent::CWizardStep();
	}
	...
	public static function DisplayTree(&$arStructure, $systemTree = false)
	{
		$strTree = "";
...
class CPackageStartInstall extends CWizardStep
{
	...
	public static function CPackageStartInstall($package, $arSelected)
	{
		$this->package = $package;
...
class CPackageInstallSite extends CWizardStep
{
	...
	public static function CPackageInstallSite($package, $siteID)
	{
		$this->package = $package;
		$this->siteID = $siteID;
		parent::CWizardStep();
...
class CPackageInstallTemplate extends CWizardStep
{
	...
	public static function CPackageInstallTemplate($package, $templateID)
	{
		$this->package = $package;
...
class CPackageInstallService extends CWizardStep
{
	...
	public static function CPackageInstallService($package, $serviceID)
	{
		$this->package = $package;
...
class CPackageFinish extends CWizardStep
{
	...
	public static function CPackageStepFinal($package)
	{
		$this->package = $package;
		parent::CWizardStep();
	}
...
class CPackageCancel extends CWizardStep
{
	...
	public static function CPackageCancel($package)
	{
		$this->package = $package;
		parent::CWizardStep();
	}
...
class CPackageError extends CWizardStep
{
	...
	public static function CPackageError($package)
	{
		$this->package = $package;
		parent::CWizardStep();
	}
