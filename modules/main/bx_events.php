...
class _CEventsMain {
	...
	/**
	 * Событие <b>OnBeforeEventAdd</b> вызывается в момент добавление почтового события <a href="http://dev.1c-bitrix.ru/api_help/main/general/mailevents.php">в таблицу b_event</a>. Как правило, задача обработчика данного события - изменить или добавить какое-либо значение, передаваемое в макросы почтового шаблона.   <p></p>
	 *
	 *
	 *
	 *
	...
	/**
	 * <p>Событие вызывается в методе <a href="http://dev.1c-bitrix.ru/api_help/main/reference/cgroup/add.php">CGroup::Add</a> до добавления группы, и может быть использовано для отмены добавления или переопределения некоторых полей.</p> <p><b>Примечание</b>: событие добавлено в ядре 9.5.8.</p>
	 *
	 *
	 *
	 *
	...
	/**
	 * Событие "OnBeforeUserRegister" вызывается до попытки регистрации нового пользователя методом <a href="http://dev.1c-bitrix.ru/api_help/main/reference/cuser/register.php">CUser::Register</a> и может быть использовано для прекращения процесса регистрации или переопределения некоторых полей.
	 *
	 *
	 *
	 *
