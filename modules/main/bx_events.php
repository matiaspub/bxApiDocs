...
class _CEventsMain {
	 ...
	 * странице <a
	 * href="http://dev.1c-bitrix.ruapi_help/main/general/admin.section/classes/cadmincontextmenu/cadmincontextmenu.php">Конструктор
	 * CAdminContextMenu</a>.
	 *
	 *
	 *
	 ...
	 * ></a>События</li> <li><a
	 * href="http://dev.1c-bitrix.ruapi_help/main/general/admin.section/classes/cadmincontextmenu/index.php">Класс
	...
	/**
	 * <p>Событие OnAdminListDisplay вызывается в функции <a href="http://dev.1c-bitrix.ruapi_help/main/general/admin.section/classes/cadminlist/display.php">CAdminList::Display()</a> при выводе в административном разделе списка элементов. Событие позволяет модифицировать объект списка, в частности, добавить произвольные групповые действия над элементами списка, добавить команды в меню действий элемента списка и т.п.</p> <p><b>Примечание</b>: событие добавлено в ядро начиная с версии 9.5.10.</p>
	 *
	 *
	 *
	 *
	 * @param object &$list  Ссылка на объект класса <a
	 * href="http://dev.1c-bitrix.ruapi_help/main/general/admin.section/classes/cadminlist/index.php">CAdminList</a>.
	 *
	 *
	 *
	 * @return void 
	 ...
	 * <ul> <li> <a href="http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=43&amp;LESSON_ID=3493"
	 * ></a>События</li> <li><a
	 * href="http://dev.1c-bitrix.ruapi_help/main/general/admin.section/classes/cadminlistrow/index.php">Класс
	...
	/**
	 * <p>Событие OnAdminTabControlBegin вызывается в функции <a href="http://dev.1c-bitrix.ruapi_help/main/general/admin.section/classes/cadmintabcontrol/begin.php">CAdminTabControl::Begin()</a> при выводе в административном интерфейсе формы редактирования. Событие позволяет изменить или добавить собственные вкладки формы редактирования.</p> <p><b>Примечание</b>: событие добавлено в ядро начиная с версии 9.5.10.</p>
	 *
	 *
	 *
	 *
	 * @param  &$form  Ссылка на объект класса <a
	 * href="http://dev.1c-bitrix.ruapi_help/main/general/admin.section/classes/cadmintabcontrol/index.php">CAdminTabControl</a>.
	 ...
	 * <a
	 * href="http://dev.1c-bitrix.ruapi_help/main/general/admin.section/classes/cadmintabcontrol/cadmintabcontrol.php">Конструктор
	 * CAdminTabControl</a>.
	 *
	 *
	 *
	 ...
	 * <ul> <li> <a href="http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=43&amp;LESSON_ID=3493"
	 * ></a>События</li> <li><a
	 * href="http://dev.1c-bitrix.ruapi_help/main/general/admin.section/rubric_edit.php">Создание формы
	...
	/**
	 * <p>Событие "OnAfterEpilog" возникает в конце выполняемой части эпилога сайта (после события <a href="http://dev.1c-bitrix.ruapi_help/main/events/onepilog.php">OnEpilog</a>). </p>
	 *
	 *
	 *
	 *
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li><a href="http://dev.1c-bitrix.ruapi_help/main/events/onepilog.php">Событие "OnEpilog"</a></li> <li><a
	 * href="http://dev.1c-bitrix.ruapi_help/main/general/pageplan.php">Этапы выполнения страницы и
	...
	/**
	 * <p>Событие вызывается в методе <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cgroup/add.php">CGroup::Add</a> после добавления группы, и может быть использовано для действий, связанных с группой.</p>
	 *
	 *
	 *
	 *
	 * @param array &$arFields  Список полей (<a href="http://dev.1c-bitrix.ruapi_help/main/reference/cgroup/index.php">класс
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li> <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cgroup/index.php">CGroup</a> </li> <li> <a
	 * href="http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=43&amp;LESSON_ID=3493" ></a>События</li>
	 * </ul><a name="examples"></a>
	 *
	 *
	...
	/**
	 * <p>Событие вызывается в методе <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cgroup/update.php">CGroup::Update</a> после изменения полей группы, и может быть использовано для дополнительных действий, связанных с группой.</p> <p><b>Примечание</b>: событие добавлено в ядре 9.5.8.</p>
	 *
	 *
	 *
	 *
	...
	/**
	 * Событие "OnAfterUserAdd" вызывается после попытки добавления нового пользователя методом <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/add.php">CUser::Add</a>.
	 *
	 *
	 *
	 *
	 * @param array &$arFields  <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/index.php#fuser">Массив полей</a> нового
	 ...
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/add.php">CUser::Add</a> и, в случае ошибки,
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li><a href="http://dev.1c-bitrix.ruapi_help/main/events/onbeforeuseradd.php">Событие
	...
	/**
	 * Обработчик события будет вызван из метода <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/authorize.php">CUser::Authorize</a> после авторизации пользователя, передавая в параметре <i>user_fields</i> массив всех полей авторизованного пользователя.
	 *
	 *
	 *
	 *
	 * @param array $user_fields  Массив всех <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/index.php">полей
	 * пользователя</a>.
	 *
	 *
	 *
	...
	/**
	 * <p>Событие "OnAfterUserLogin" вызывается в методе <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/login.php">CUser::Login</a> после попытки авторизовать пользователя, проверив имя входа <i><span class="syntax"><i>arParams</i></span>['LOGIN']</i> и пароль <i><span class="syntax"><i>arParams</i></span>['PASSWORD']</i>.</p>
	 *
	 *
	 *
	 *
	 ...
	 * href="http://dev.1c-bitrix.ruapi_help/main/functions/other/showmessage.php">ShowMessage</a> для вывода
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li><a href="http://dev.1c-bitrix.ruapi_help/main/events/onbeforeuserlogin.php">Событие
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li><a href="http://dev.1c-bitrix.ruapi_help/main/events/onbeforeuserloginbyhash.php">Событие
	...
	/**
	 * Событие "OnAfterUserLogout" вызывается после <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/logout.php">завершения авторизации</a> пользователя.
	 *
	 *
	 *
	 *
	 ...
	 * href="http://dev.1c-bitrix.ruapi_help/main/events/onbeforeuserlogout.php">OnBeforeUserLogout</a>.</li> </ul>
	 *
	 *
	 *
	 * @return mixed 
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li> <a href="http://dev.1c-bitrix.ruapi_help/main/events/onbeforeuserlogout.php">Событие
	...
	/**
	 * Событие "OnAfterUserRegister" вызывается после попытки регистрации нового пользователя методом <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/register.php">CUser::Register</a>.
	 *
	 *
	 *
	 *
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li> <a href="http://dev.1c-bitrix.ruapi_help/main/events/onbeforeuserregister.php">Событие
	 * "OnBeforeUserRegister"</a> </li> <li> <a
	 * href="http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=43&amp;LESSON_ID=3493" ></a>События</li> <li>
	 * <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/register.php">CUser::Register</a> </li> </ul><a
	 * name="examples"></a>
	 *
	 *
	 * @static
	...
	/**
	 * Событие "OnAfterUserSimpleRegister" вызывается после попытки упрощённой регистрации нового пользователя методом <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/simpleregister.php">CUser::SimpleRegister</a>.
	 *
	 *
	 *
	 *
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li><a href="http://dev.1c-bitrix.ruapi_help/main/events/onbeforeusersimpleregister.php">Событие
	 ...
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/register.php">CUser::Register</a></li> </ul><a
	 * name="examples"></a>
	 *
	 *
	 * @static
	...
	/**
	 * Событие <b>OnAfterUserUpdate</b> вызывается после попытки изменения свойств пользователя методом <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/update.php">CUser::Update</a>.
	 *
	 *
	 *
	 *
	 * @param array &$arFields  <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/index.php#fuser">Массив полей</a>
	 * изменяемого пользователя. Дополнительно, в элементе массива с
	 * индексом <i>RESULT</i> содержится результат работы (возвращаемое
	 * значение) метода <a
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/update.php">CUser::Update</a> и, в случае
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li><a href="http://dev.1c-bitrix.ruapi_help/main/events/onbeforeuserupdate.php">Событие
	...
	/**
	 * <p>Событие "OnBeforeChangeFile" вызывается при изменении файла методом <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cmain/savefilecontent.php">$APPLICATION-&gt;SaveFileContent</a>, перед его сохранением. Событие добавлено в версии 8.5.1 ядра. Контент в событие передается по ссылке.</p>
	 *
	 *
	 *
	 *
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li> <a href="http://dev.1c-bitrix.ruapi_help/main/events/onchangepermissions.php">Событие
	...
	/**
	 * Событие <b>OnBeforeEventAdd</b> вызывается в момент добавление почтового события <a href="http://dev.1c-bitrix.ruapi_help/main/general/mailevents.php">в таблицу b_event</a>. Как правило, задача обработчика данного события - изменить или добавить какое-либо значение, передаваемое в макросы почтового шаблона.   <p></p>
	 *
	 *
	 *
	 *
	 ...
	 *
	 *
	 * @param string &$message_id  Идентификатор почтового шаблона (если указан) - с версии ядра 11.0.16.
	 *
	 *
	 *
	 * @return mixed <div>Нет. Начиная с версии ядра 11.0.16 при возврате <em>false</em> добавление
	 * почтового события отменяется.</div><p></p>
	 *
	 *
	 * <h4>Example</h4> 
	 * <pre>
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li> <a href="http://dev.1c-bitrix.ruapi_help/main/events/onbeforeeventsend.php">Событие
	 * "OnBeforeEventSend"</a> </li> <li> <a
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/cevent/send.php">CEvent::Send</a> </li> <li> <a
	 * href="http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=43&amp;LESSON_ID=3493" ></a>События</li>
	 * </ul><p></p><a name="examples"></a>
	 *
	 *
	 * @static
	 ...
	 * @author Bitrix
	 */
	public static function OnBeforeEventAdd(&$event, &$lid, &$arFields, &$message_id){}

	/**
	 * Событие "OnBeforeEventMessageDelete" вызывается перед <a href="http://dev.1c-bitrix.ruapi_help/main/reference/ceventmessage/delete.php">удалением почтового шаблона</a>. Как правило задачи обработчика данного события - разрешить или запретить удаление почтового шаблона.
	 *
	 *
	 *
	 *
	 ...
	 *
	 * @return bool <a
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/ceventmessage/delete.php">CEventMessage::Delete</a><nobr>$APPLICATION-&gt;<a
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li><a href="http://dev.1c-bitrix.ruapi_help/main/events/oneventmessagedelete.php">Событие
	 * "OnEventMessageDelete"</a></li> <li><a
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/ceventmessage/delete.php">CEventMessage::Delete</a></li> <li> <a
	 * href="http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=43&amp;LESSON_ID=3493" ></a>События</li>
	 * </ul><a name="examples"></a>
	 *
	 *
	...
	/**
	 * <p>Событие вызывается в методе <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cgroup/add.php">CGroup::Add</a> до добавления группы, и может быть использовано для отмены добавления или переопределения некоторых полей.</p> <p><b>Примечание</b>: событие добавлено в ядре 9.5.8.</p>
	 *
	 *
	 *
	 *
	 ...
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/cgroup/add.php">CGroup::Add</a> необходимо в
	 * функции-обработчике создать исключение методом
	 * <nobr>$APPLICATION-&gt;</nobr><a
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/cmain/throwexception.php">ThrowException()</a> и вернуть
	 * <i>false</i>.</p>
	 *
	 *
	 * <h4>Example</h4> 
	...
	/**
	 * Событие "OnBeforeGroupDelete" вызывается перед <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cgroup/delete.php">удалением группы пользователей</a>. Как правило задачи обработчика данного события - разрешить или запретить удаление группы пользователей.
	 *
	 *
	 *
	 *
	 ...
	 *
	 *
	 * @return bool <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cgroup/delete.php">CGroup::Delete</a><nobr>$APPLICATION-&gt;<a
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/cmain/throwexception.php">ThrowException()</a></nobr><i>false</i>
	 *
	 *
	 * <h4>Example</h4> 
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li><a href="http://dev.1c-bitrix.ruapi_help/main/events/ongroupdelete.php">Событие "OnGroupDelete"</a></li>
	 * <li><a href="http://dev.1c-bitrix.ruapi_help/main/reference/cgroup/delete.php">CGroup::Delete</a></li> <li> <a
	 * href="http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=43&amp;LESSON_ID=3493" ></a>События</li>
	 * </ul><a name="examples"></a>
	 *
	 *
	...
	/**
	 * <p>Событие вызывается в методе <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cgroup/update.php">CGroup::Update</a> до изменения полей группы, и может быть использовано для отмены изменения или переопределения некоторых полей.</p> <p><b>Примечание</b>: событие добавлено в ядре 9.5.8.</p>
	 *
	 *
	 *
	 *
	 ...
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/cgroup/update.php">CGroup::Update</a> необходимо в
	 * функции-обработчике создать исключение методом
	 * <nobr>$APPLICATION-&gt;</nobr><a
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/cmain/throwexception.php">ThrowException()</a> и вернуть
	 * <i>false</i>.</p>
	...
	/**
	 * Событие "OnBeforeLanguageDelete" вызывается перед <a href="http://dev.1c-bitrix.ruapi_help/main/reference/clanguage/delete.php">удалением языка</a>. Как правило задачи обработчика данного события - разрешить или запретить удаление языка.
	 *
	 *
	 *
	 *
	 ...
	 *
	 * @return bool <a
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/clanguage/delete.php">CLanguage::Delete</a><nobr>$APPLICATION-&gt;<a
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li><a href="http://dev.1c-bitrix.ruapi_help/main/events/onlanguagedelete.php">Событие
	 * "OnLanguageDelete"</a></li> <li><a
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/clanguage/delete.php">CLanguage::Delete</a></li> <li> <a
	...
	/**
	 * Событие "OnBeforeProlog" вызывается в выполняемой части пролога сайта (после события <a href="http://dev.1c-bitrix.ruapi_help/main/events/onpagestart.php">OnPageStart</a>).
	 *
	 *
	 *
	 *
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li><a href="http://dev.1c-bitrix.ruapi_help/main/events/onpagestart.php">Событие "OnPageStart"</a></li>
	 * <li><a href="http://dev.1c-bitrix.ruapi_help/main/general/pageplan.php">Этапы выполнения страницы
	 * и доступные на каждом этапе переменные и константы </a></li> <li> <a
	 * href="http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=43&amp;LESSON_ID=3493" ></a>События</li>
	 * </ul><a name="examples"></a>
	 *
	 *
	...
	/**
	 * Событие "OnBeforeSiteDelete" вызывается перед <a href="http://dev.1c-bitrix.ruapi_help/main/reference/csite/delete.php">удалением сайта</a>. Как правило задачи обработчика данного события - разрешить или запретить удаление сайта.
	 *
	 *
	 *
	 *
	 ...
	 *
	 *
	 * @return bool <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/delete.php">CSite::Delete</a><nobr>$APPLICATION-&gt;<a
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/cmain/throwexception.php">ThrowException()</a></nobr><i>false</i>
	 *
	 *
	 * <h4>Example</h4> 
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li><a href="http://dev.1c-bitrix.ruapi_help/main/events/onsitedelete.php">Событие "OnSiteDelete"</a></li>
	 * <li><a href="http://dev.1c-bitrix.ruapi_help/main/reference/csite/delete.php">CSite::Delete</a></li> <li> <a
	 * href="http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=43&amp;LESSON_ID=3493" ></a>События</li>
	 * </ul><a name="examples"></a>
	 *
	 *
	...
	/**
	 * Событие вызывается в методе <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/add.php">CUser::Add</a> до вставки нового пользователя, и может быть использовано для отмены вставки или переопределения некоторых полей.
	 *
	 *
	 *
	 *
	 * @param array &$arParams  <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/index.php#fuser">Массив полей</a> нового
	 * пользователя.
	 *
	 *
	 *
	 * @return bool <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/add.php">CUser::Add</a><nobr>$APPLICATION-&gt;<a
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/cmain/throwexception.php">ThrowException()</a></nobr><i>false</i><br>
	 *
	 *
	 * <h4>Example</h4> 
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li><a href="http://dev.1c-bitrix.ruapi_help/main/events/onafteruseradd.php">Событие
	 * "OnAfterUserAdd"</a></li> <li><a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/add.php">CUser::Add</a></li>
	...
	/**
	 * Событие "OnBeforeUserDelete" вызывается перед <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/delete.php">удалением пользователя</a>. Как правило задачи обработчика данного события - разрешить или запретить удаление пользователя.
	 *
	 *
	 *
	 *
	 ...
	 *
	 *
	 * @return bool <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/delete.php">CUser::Delete</a><nobr>$APPLICATION-&gt;<a
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/cmain/throwexception.php">ThrowException()</a></nobr><i>false</i>
	 *
	 *
	 * <h4>Example</h4> 
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li><a href="http://dev.1c-bitrix.ruapi_help/main/events/onuserdelete.php">Событие "OnUserDelete"</a></li>
	 * <li><a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/delete.php">CUser::Delete</a></li> <li> <a
	 * href="http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=43&amp;LESSON_ID=3493" ></a>События</li>
	 * </ul><a name="examples"></a>
	 *
	 *
	 ...
	 *
	 *
	 * @return bool <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/login.php">CUser::Login</a><nobr>$APPLICATION-&gt;<a
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/cmain/throwexception.php">ThrowException()</a></nobr><i>false</i><br>
	 *
	 *
	 * <h4>Example</h4> 
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li><a href="http://dev.1c-bitrix.ruapi_help/main/events/onafteruserlogin.php">Событие
	 ...
	 *
	 * @return bool <a
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/loginbyhash.php">CUser::LoginByHash</a><nobr>$APPLICATION-&gt;<a
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/cmain/throwexception.php">ThrowException()</a></nobr><i>false</i>
	 *
	 *
	 * <h4>Example</h4> 
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li><a href="http://dev.1c-bitrix.ruapi_help/main/events/onafteruserloginbyhash.php">Событие
	...
	/**
	 * <p>Вызывается перед завершением сеанса авторизации пользователя методом <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/logout.php">CUser::Logout</a> и может быть использовано для отмены завершения сеанса. </p>
	 *
	 *
	 *
	 *
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li><a href="http://dev.1c-bitrix.ruapi_help/main/events/onafteruserlogout.php">Событие
	...
	/**
	 * Событие "OnBeforeUserRegister" вызывается до попытки регистрации нового пользователя методом <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/register.php">CUser::Register</a> и может быть использовано для прекращения процесса регистрации или переопределения некоторых полей.
	 *
	 *
	 *
	 *
	 ...
	 *
	 *
	 * @return bool <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/register.php">CUser::Register</a><nobr>$APPLICATION-&gt;<a
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/cmain/throwexception.php">ThrowException()</a></nobr><i>false</i>
	 *
	 *
	 * <h4>Example</h4> 
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li><a href="http://dev.1c-bitrix.ruapi_help/main/events/onafteruserregister.php">Событие
	 ...
	 *
	 * @return bool <a
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/simpleregister.php">CUser::SimpleRegister</a><nobr>$APPLICATION-&gt;<a
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/cmain/throwexception.php">ThrowException()</a></nobr><i>false</i>
	 *
	 *
	 * <h4>Example</h4> 
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li> <a href="http://dev.1c-bitrix.ruapi_help/main/events/onafterusersimpleregister.php">Событие
	...
	/**
	 * Событие вызывается в методе <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/update.php">CUser::Update</a> до изменения параметров пользователя, и может быть использовано для отмены изменения или переопределения некоторых полей.
	 *
	 *
	 *
	 *
	 * @param array &$arParams  <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/index.php#fuser">Массив полей</a>
	 * изменяемого пользователя.
	 *
	 *
	 *
	 * @return bool <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/update.php">CUser::Update</a><nobr>$APPLICATION-&gt;<a
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/cmain/throwexception.php">ThrowException()</a></nobr><i>false</i><br>
	 *
	 *
	 * <h4>Example</h4> 
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li> <a href="http://dev.1c-bitrix.ruapi_help/main/events/onafteruserupdate.php">Событие
	...
	/**
	 * Событие "OnChangePermissions" вызывается при изменении прав доступа к файлу или папке методом <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cmain/setfileaccesspermission.php">$APPLICATION-&gt;SetFileAccessPermission</a>.
	 *
	 *
	 *
	 *
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li> <a href="http://dev.1c-bitrix.ruapi_help/main/events/onbeforechangefile.php">Событие "OnChangeFile"</a>
	 * </li> <li> <a
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li> <a href="http://dev.1c-bitrix.ruapi_help/main/events/onafterepilog.php">Событие "OnAfterEpilog"</a>
	 * </li> <li><a href="http://dev.1c-bitrix.ruapi_help/main/general/pageplan.php">Этапы выполнения
	...
	/**
	 * Событие "OnEventMessageDelete" вызывается во время <a href="http://dev.1c-bitrix.ruapi_help/main/reference/ceventmessage/delete.php">удаления почтового шаблона</a>. Как правило задачи обработчика данного события - очистить базу данных от записей связанных с удаляемым почтовым шаблоном.
	 *
	 *
	 *
	 *
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li><a href="http://dev.1c-bitrix.ruapi_help/main/events/onbeforeeventmessagedelete.php">Событие
	...
	/**
	 * Событие "OnExternalAuthList" вызывается для получения списка источников внешней авторизации<a href="http://dev.1c-bitrix.ruapi_help/main/reference/clanguage/delete.php"></a> при вызове метода <a href="../cuser/getexternalauthlist.php.html">CUser::GetExternalAuthList</a>.
	 *
	 *
	 *
	 *
	 ...
	 * <ul> <li> <a href="http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=43&amp;LESSON_ID=3493"
	 * ></a>События</li> <li><a
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/getexternalauthlist.php">CUser::GetExternalAuthList </a></li>
	 * <li> <a href="http://dev.1c-bitrix.ru/learning/course/index.php?&amp;COURSE_ID=43&amp;LESSON_ID=3574"
	 * ></a>Внешняя авторизация </li> </ul><a name="examples"></a>
	 *
	 *
	...
	/**
	 * <p>Событие "OnFileDelete" вызывается после удаления файла в методе <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cfile/delete.php">CFile::Delete</a>. Событие может использоваться для удаления производной от файла информации (созданных при загрузке картинки эскизов и т.п.).</p> <p><b>Примечание</b>: Событие добавлено в версии 10.0.5 ядра.</p>
	 *
	 *
	 *
	 *
	...
	/**
	 * Событие "OnGroupDelete" вызывается в момент <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cgroup/delete.php">удаления группы пользователей</a>. Как правило задачи обработчика данного события - очистить базу данных от записей связанных с удаляемой группой пользователей.
	 *
	 *
	 *
	 *
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li><a href="http://dev.1c-bitrix.ruapi_help/main/events/onbeforegroupdelete.php">Событие
	 * "OnBeforeGroupDelete"</a></li> <li><a
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/cgroup/delete.php">CGroup::Delete</a></li> <li> <a
	 * href="http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=43&amp;LESSON_ID=3493" ></a>События</li>
	 * </ul><a name="examples"></a>
	 *
	 *
	...
	/**
	 * Событие "OnLanguageDelete" вызывается во время <a href="http://dev.1c-bitrix.ruapi_help/main/reference/clanguage/delete.php">удаления языка</a>. Как правило задачи обработчика данного события - очистить базу данных от записей связанных с удаляемым языком.
	 *
	 *
	 *
	 *
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li><a href="http://dev.1c-bitrix.ruapi_help/main/events/onbeforelanguagedelete.php">Событие
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li><a href="http://dev.1c-bitrix.ruapi_help/main/events/onbeforeprolog.php">Событие
	 * "OnBeforeProlog"</a></li> <li><a href="http://dev.1c-bitrix.ruapi_help/main/general/pageplan.php">Этапы
	...
	/**
	 * Событие "OnPanelCreate" вызывается в момент сбора данных для <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cmain/showpanel.php">построения</a> <a href="http://dev.1c-bitrix.ruapi_help/main/general/panel.php">панели управления</a> в публичной части сайта. Как правило задачи обработчика данного события - добавлять свои кнопки в панель управления сайтом.
	 *
	 *
	 *
	 *
	 ...
	 * <li><a href="http://dev.1c-bitrix.ruapi_help/main/reference/cmain/addpanelbutton.php">CMain::AddPanelButton</a></li>
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li> <a href="http://dev.1c-bitrix.ruapi_help/main/events/onbeforeprolog.php">Событие "OnBeforeProlog"</a>
	 * </li> <li><a href="http://dev.1c-bitrix.ruapi_help/main/general/pageplan.php">Этапы выполнения
	 * страницы и доступные на каждом этапе переменные и константы </a></li>
	 * <li> <a href="http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=43&amp;LESSON_ID=3493"
	 * ></a>События</li> </ul><a name="examples"></a>
	 ...
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/index.php">поля пользователя</a>,
	 ...
	 * <li> <a href="http://dev.1c-bitrix.ruapi_help/main/general/mailevents.php">Почтовые события</a> </li>
	 * <li> <a href="http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=43&amp;LESSON_ID=3493"
	 * ></a>События</li> </ul><a name="examples"></a>
	 *
	 *
	...
	/**
	 * Событие "OnSiteDelete" вызывается во время <a href="http://dev.1c-bitrix.ruapi_help/main/reference/csite/delete.php">удаления сайта</a>. Как правило задачи обработчика данного события - очистить базу данных от записей связанных с удаляемым сайтом.
	 *
	 *
	 *
	 *
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li><a href="http://dev.1c-bitrix.ruapi_help/main/events/onbeforesitedelete.php">Событие
	 * "OnBeforeSiteDelete"</a></li> <li><a
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/csite/delete.php">CSite::Delete</a></li> <li> <a
	 * href="http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=43&amp;LESSON_ID=3493" ></a>События</li> </ul>
	 *
	 *
	 * @static
	...
	/**
	 * Событие "OnUserDelete" вызывается в момент <a href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/delete.php">удаления пользователя</a>. Как правило задачи обработчика данного события - очистить базу данных от записей связанных с удаляемым пользователем.
	 *
	 *
	 *
	 *
	 ...
	 *
	 * <h4>See Also</h4> 
	 * <ul> <li><a href="http://dev.1c-bitrix.ruapi_help/main/events/onbeforeuserdelete.php">Событие
	 * "OnBeforeUserDelete"</a></li> <li><a
	 * href="http://dev.1c-bitrix.ruapi_help/main/reference/cuser/delete.php">CUser::Delete</a></li> <li> <a
	 * href="http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=43&amp;LESSON_ID=3493" ></a>События</li>
	 * </ul><a name="examples"></a>
	 *
	 *
	 ...
	 * <ul> <li> <a href="http://dev.1c-bitrix.ruapi_help/main/events/onbeforeuserlogin.php">Событие
	 * "OnBeforeUserLogin"</a> </li> <li><a
	 * href="http://dev.1c-bitrix.ruapi_help/main/events/onafteruserlogin.php">Событие "OnAfterUserLogin"</a></li> <li>
