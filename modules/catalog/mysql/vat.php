...
class CCatalogVat extends CAllCatalogVat
{
	...
	/**
	* <p>Метод добавляет новую ставку НДС в соответствии с данными из массива <i>arFields</i>. Нестатический метод.</p>
	*
	*
	...
	*/
	...
	/**
	* <p>Метод изменяет параметры ставки НДС с кодом <i>ID</i> в соответствии с данными из массива <i>arFields</i>. Нестатический метод.</p>
	*
	*
	...
	*/
	...
	/**
	* <p>Метод удаляет ставку НДС с кодом <i>ID</i>. Нестатический метод.</p>
	*
	*
	* @param mixed $intID  Код ставки НДС.
	*
	...
	*/
	...
	/**
	* <p>Метод возвращает результат выборки записей из таблицы ставок НДС в соответствии со своими параметрами. Нестатический метод.</p>
	*
	*
	...
	*           <li> <b> 	+</b> - значения null, 0 и пустая строка так же удовлетворяют
	* условиям фильтра.</li>          		</ul>        	Допустимыми являются
	* следующие операторы: 	         <ul> <li> <b>&gt;=</b> - значение поля больше или
	...
	*     <br><br>        	Значение по умолчанию - пустой массив array() - означает,
	...
	* качестве "название_поля<i>N</i>" может стоять любое поле. Если массив
	* пустой, то метод вернет число записей, удовлетворяющих фильтру.    
	*     <br><br>        		Значение по умолчанию - <i>false</i> - означает, что
