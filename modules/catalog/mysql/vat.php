...
class CCatalogVat extends CAllCatalogVat
{
	...
	/**
	* <p>Метод добавляет новую ставку НДС в соответствии с данными из массива <i>arFields</i>.</p>
	*
	*
	*
	*
	...
	*/
	...
	/**
	* <p>Метод изменяет параметры ставки НДС с кодом <i>ID</i> в соответствии с данными из массива <i>arFields</i>.</p>
	*
	*
	*
	*
	...
	*/
	...
	/**
	* <p>Метод удаляет ставку НДС с кодом <i>ID</i>.</p>
	*
	*
	*
	*
	...
	*/
	...
	/**
	* <p>Метод возвращает результат выборки записей из таблицы ставок НДС в соответствии со своими параметрами.</p>
	*
	*
	*
	*
