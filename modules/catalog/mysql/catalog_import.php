...
class CCatalogImport extends CAllCatalogImport
{
	...
	/**
	* <p>Метод добавляет новый профиль импорта. Нестатический метод.</p> <p></p> <div class="note"> <b>Примечание</b>: в данном методе отключена возможность заносить значения в обход CheckFields, кроме одного исключения: <pre class="syntax">"=LAST_USE" =&gt; $DB-&gt;GetNowFunction()</pre> </div>
	*
	*
