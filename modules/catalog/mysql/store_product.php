	...
	extends CCatalogStoreProductAll
{
	...
	* Допустимые ключи:         <br><ul> <li>PRODUCT_ID - ID товара;</li>                    <li>STORE_ID
	* - ID склада;</li> 		   		  <li>AMOUNT - количество товара;</li>                  </ul>
	*
	...
	* величины;</li>          			            <li> <b>@</b> - оператор может использоваться
	* для целочисленных и вещественных данных при передаче набора
	...
	* "название_поляX" может стоять любое поле.          <br><br>        	Значение
	* по умолчанию - пустой массив array() - означает, что результат
