...
class CExtra extends CAllExtra
{
	...
	*/
	...
	/**
	* <p>Метод возвращает список наценок в соответствии с фильтром и условиями сортировки.</p> <p>В таком виде метод работает с версии <b>11.0.0</b>. До этой версии использовалась устаревшая форма вызова метода (см. <a href="#old">ниже</a>).</p>
	*
	*
	*
	*
