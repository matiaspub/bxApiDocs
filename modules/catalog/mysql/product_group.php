...
class CCatalogProductGroups extends CAllCatalogProductGroups
{
	...
	/**
	 * <p>Метод добавляет новую запись с информацией о связи товара и группы пользователей, к которой пользователь привязывается при покупке товара, в соответствии с данными из массива arFields.</p>
	 *
	 *
	 *
	 *
	...
	/**
	 * <p>Функция возвращает результат выборки записей информации о связи товаров и групп пользователей, к которым пользователь привязывается при покупке товара, в соответствии со своими параметрами.</p>
	 *
	 *
	 *
	 *
