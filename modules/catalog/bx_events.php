...
class _CEventsCatalog {
	...
	/**
	 * после OnBeforeDocumentDelete в методе CCatalogStoreDocsBarcodeAll::OnBeforeDocumentDelete.</body>
	 * </
	 * 
	 * <i>Вызывается в методе:</i><br>
	...
	/**
	 * после OnDocumentBarcodeDelete в методе CCatalogStoreDocsElementAll::OnDocumentBarcodeDelete.</body>
	 * </
	 * 
	 * <i>Вызывается в методе:</i><br>
	...
	/**
	 * <p>OnGenerateCoupon - событие, вызываемое в функции <b>CatalogGenerateCoupon()</b>. Позволяет заменить стандартный метод генерации кода купона.</p> <p><b>Примечание:</b> длина купона не может быть больше 32 символов.</p>
	 *
	 *
	 *
	 *
	...
	/**
	 * в начале метода CCatalogDiscSave::GetDiscount.</body>
	 * </
	 * 
	 * <i>Вызывается в методе:</i><br>
	 ...
	 * @author Bitrix
	 */
	public static function OnBeforeStoreProductUpdate($arFields){}
