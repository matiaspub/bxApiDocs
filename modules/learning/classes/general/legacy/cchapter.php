...
class CChapter
{
	...
	/**
	 * <p>Функция возвращает путь по дереву от корня до главы CHAPTER_ID.</p>
	 *
	 *
	 *
	 *
	 ...
	 *
	 *
	 * @param int $CHAPTER_ID  Идентификатор главы.
	 *
	 *
	 *
	 ...
	 * href="http://dev.1c-bitrix.ruapi_help/learning/classes/cchapter/index.php">CChapter</a>::<a
	 * href="http://dev.1c-bitrix.ruapi_help/learning/classes/cchapter/getbyid.php">GetByID</a> </li> <li> <a
	 * href="http://dev.1c-bitrix.ruapi_help/learning/fields.php#chapter">Поля главы</a> </li> </ul><a
	 * name="examples"></a>
	 *
	 *
	 * @static
