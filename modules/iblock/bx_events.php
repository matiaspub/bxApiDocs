...
class _CEventsIblock {
	...
	/**
	 * Событие вызывается в методе <a href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblockelement/add.php">CIBlockElement::Add</a> до вставки информационного блока, и может быть использовано для отмены вставки или переопределения некоторых полей.
	 *
	 *
	 *
	 *
	...
	/**
	 * <p>Событие вызывается в методе <a href="http://dev.1c-bitrix.ru/api_help/iblock/classes/ciblockelement/add.php">CIBlockElement::Add</a> до добавления элемента инфоблока перед проверкой правильности заполнения полей, и может быть использовано для отмены выполнения других обработчиков событий.</p>
	 *
	 *
	 *
	 *
	 ...
	 * случае ошибки, элемент с индексом "RESULT_MESSAGE" будет содержать текст
	 * ошибки.<br><br><b>Примечание:</b> изменения в массиве <i>arFields</i> не
	 * приведут к изменениям в элементе инфоблока.
	 *
	 *
	 *
	 * @return mixed 
	...
	/**
	 * аналог <a href="/api_help/main/events/onadmincontextmenushow.php">OnAdminContextMenuShow</a> для списка SKU</body>
	 * </h
	 * 
	 * <i>Вызывается в методе:</i><br>
	...
	/**
	 * аналог <a href="/api_help/main/events/onadminlistdisplay.php">OnAdminListDisplay</a> для списка SKU</body>
	 * </h
	 * 
	 * <i>Вызывается в методе:</i><br>
