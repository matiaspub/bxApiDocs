...
class CAllSaleOrderPropsVariant
{
	...
	/**
	* <p>Метод возвращает параметры варианта значения свойства заказа по коду свойства заказа и значению. Нестатический метод.</p>
	*
	*
	...
	* с ключами:</p><table class="tnormal" width="100%"> <tr> <th width="15%">Код</th>    
	* <th>Описание</th>   </tr> <tr> <td>ID</td>     <td>Код варианта значения свойства
	* заказа.</td> </tr> <tr> <td>ORDER_PROPS_ID</td>     <td>Код свойства заказа.</td> </tr> <tr>
	* <td>NAME</td>     <td>Название варианта.</td> </tr> <tr> <td>VALUE</td>     <td>Значение
	* варианта.</td> </tr> <tr> <td>SORT</td>     <td>Индекс сортировки.</td> </tr> <tr>
	* <td>DESCRIPTION</td>     <td>Описание варианта значения свойства заказа.</td>
	...
	*/
	...
	/**
	* <p>Метод возвращает параметры варианта с кодом ID значения свойства заказа. Нестатический метод.</p>
	*
	*
	* @param mixed $intID  Код варианта значения свойства заказа.
	*
	* @return array <p>Возвращается ассоциативный массив значений параметров заказа
	* с ключами:</p><table class="tnormal" width="100%"> <tr> <th width="15%">Код</th>    
	* <th>Описание</th>   </tr> <tr> <td>ID</td>     <td>Код варианта значения свойства
	...
	*/
	...
	/**
	* <p>Метод обновляет параметры варианта с кодом ID на значения из массива arFields. Нестатический метод. </p>
	*
	*
	* @param mixed $intID  Код варианта значения свойства заказа.
	*
	...
	*/
	...
	/**
	* <p>Метод удаляет вариант с кодом ID значения свойства заказа. Нестатический метод.</p>
	*
	*
	* @param mixed $intID  Код варианта значения свойства заказа.
	*
	...
	*/
	...
	/**
	* <p>Метод удаляет все варианты значений для свойства с кодом ID заказа. Нестатический метод.</p>
	*
	*
