...
class CAllSaleLocationGroup
{
	...
	/**
	* <p>Метод возвращает набор местоположений, связанных с группами местоположений, удовлетворяющих фильтру arFilter. Нестатический метод.</p>
	*
	*
	...
	*/
	...
	/**
	* <p>Метод возвращает языкозависимые параметры группы местоположений с кодом ID для языка с кодом strLang. Нестатический метод.</p>
	*
	*
	...
	*/
	...
	/**
	* <p>Метод обновляет параметры местоположения с кодом ID в соответствии с параметрами из массива arFields. Обновляются также страна и город этого местоположения. Нестатический метод.</p>
	*
	*
	...
	* этот ключ заполнять не нужно);</li>  <li> <b>LOCATION_ID</b> - массив кодов
	...
	* языка);</li>  	<li> <b>SHORT_NAME</b> - сокращенное название страны -
	...
	* параметрами города должен содержать ключи:   <ul> <li> <b>NAME</b> -
	* название города (не зависящее от языка);</li>  	<li> <b>SHORT_NAME</b> -
	* сокращенное название города - аббревиатура (не зависящее от
	...
	*/
	...
	/**
	* <p>Метод удаляет группу местоположений с кодом ID. Местоположения, входящие в эту группу, не изменяются. Нестатический метод.</p>
	*
	*
	* @param mixed $intID  Код группы местоположений.
	*
