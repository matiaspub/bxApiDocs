...
class CSalePaySystem extends CAllSalePaySystem
{
	...
	*
	*
	* @param arFilte $r = array() Массив полей записей, которые будут возвращены функцией. Можно
	...
	* обработчика платежной системы (возвращается, если в функцию
	* передается тип плательщика) </td> </tr> <tr> <td>PSA_NAME</td> <td>Название
	* обработчика (возвращается, если в функцию передается тип
