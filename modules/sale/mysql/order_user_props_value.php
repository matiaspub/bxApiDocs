...
class CSaleOrderUserPropsValue extends CAllSaleOrderUserPropsValue
{
	 ...
	 * заказов.<br><br> Пример фильтра: <pre class="syntax">array("USER_PROPS_ID" =&gt; 120)</pre> Этот
	 * фильтр означает "выбрать все записи, в которых значение в поле
	 * USER_PROPS_ID (код профиля покупателя) равно 120".<br><br> Значение по
	 ...
	 * $db_propVals = CSaleOrderUserPropsValue::GetList(($b="SORT"), ($o="ASC"), Array("USER_PROPS_ID"=&gt;$ID));
