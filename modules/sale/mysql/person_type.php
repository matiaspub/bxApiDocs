...
class CSalePersonType extends CAllSalePersonType
{
	...
	/**
	* <p>Метод возвращает результат выборки записей из типов плательщика в соответствии со своими параметрами. Нестатический метод.</p>
	*
	*
	...
	* "название_поляX" может стоять любое поле 		типов плательщика.<br>
	...
	* вычисление суммы.</li> 		</ul> 		Этот фильтр означает "выбрать все
	...
	* типа плательщика.</td> </tr> <tr> <td>SORT</td>     <td>Индекс сортировки.</td> </tr>
	* <tr> <td>ACTIVE</td>     <td>Флаг активности пользователя [Y|N].</td> </tr>
	...
	*/
	...
	/**
	* <p>Метод добавляет новый тип плательщика с параметрами из массива arFields. Нестатический метод.</p>
	*
	*
