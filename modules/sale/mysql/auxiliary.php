...
class CSaleAuxiliary extends CAllSaleAuxiliary
{
	...
	/**
	* <p>Метод выбирает параметры информации о временном доступе с кодом ID. Нестатический метод.</p>
	*
	*
	...
	* <b>USER_ID</b> - код пользователя;</li> 	<li> <b>ITEM</b> - ресурс, доступ к
	* которому разрешен;</li> 	<li> <b>ITEM_MD5</b> - идентификатор ресурса (строка,
	...
	*/
	...
	/**
	* <p>Метод выбирает параметры информации о временном доступе к ресурсу с идентификатором itemMD5 для пользователя с кодом userID. Нестатический метод.</p>
	*
	*
	...
	*/
	...
	/**
	* <p>Метод возвращает результат выборки записей информации о временном доступе в соответствии со своими параметрами. Нестатический метод.</p>
	*
	*
	...
	* убыванию).<br><br> 		Если массив сортировки имеет несколько
	* элементов, то 		результирующий набор сортируется последовательно
	* по каждому элементу (т.е. сначала сортируется по первому элементу,
	* потом результат сортируется по второму и т.д.). <br><br>  Значение по
	...
	* о временном доступе. Массив имеет вид: 		<pre class="syntax">array(
	...
	* "название_поля<span lang="en-us">N</span>" может стоять любое поле
	* 		информации о временном доступе.<br><br> 		Пример фильтра: 		<pre
	...
	* идентифицирующая ресурс); 	</li> <li> <b>TIMESTAMP_X</b> - дата изменения; 	</li>
	* <li> <b>DATE_INSERT</b> - дата вставки записи.</li> </ul><p>Если в качестве
	...
	*/
	...
	/**
	* <p>Метод удаляет всю информацию о временном доступе, которая старше указанного времени. Нестатический метод.</p>
	*
	*
	...
	* час;</li> 	<li>D - сутки;</li> 	<li>W - неделя;</li> 	<li>M - месяц;</li> 	<li>Q -
	* квартал;</li> 	<li>S - полугодие;</li> 	<li>Y - год.</li> </ul>
	*
	...
	*/
	...
	/**
	* <p>Метод добавляет новую запись с информацией о временном доступе к ресурсу в соответствии с данными из массива <i>arFields</i>. Нестатический метод.</p>
	*
	*
	...
	* доступ к которому разрешен;</li> 			<li> <b>ITEM_MD5</b> - идентификатор
	* ресурса (строка, однозначно идентифицирующая ресурс);</li> 			<li>
	* <b>DATE_INSERT</b> - дата вставки записи.</li> 		</ul>
	*
	...
	*/
	...
	/**
	* <p>Метод изменяет параметры записи с кодом ID информации о временном доступе к ресурсу в соответствии с данными из массива arFields. Нестатический метод.</p>
	*
	*
	* @param mixed $intID  Код записи.
	*
