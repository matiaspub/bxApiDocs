...
class CSaleOrderPropsVariant extends CAllSaleOrderPropsVariant
{
	...
	/**
	* <p>Метод возвращает набор вариантов значений свойств заказа, удовлетворяющих фильтру arFilter. Результирующий набор отсортирован по полю by в направлении order. Нестатический метод.</p>
	*
	*
	...
	* фильтра: 		<pre class="syntax">array("~VALUE" =&gt; "SH*")</pre> 		Этот фильтр означает
	* "выбрать все записи, в которых значение в поле VALUE (значение)
	* начинается с SH".<br><br> 	Значение по умолчанию - пустой массив array() -
	...
	* width="15%">Код</th>     <th>Описание</th>   </tr> <tr> <td>ID</td>     <td>Код варианта
	* значения свойства заказа.</td> </tr> <tr> <td>ORDER_PROPS_ID</td>     <td>Код свойства
	* заказа.</td> </tr> <tr> <td>NAME</td>     <td>Название варианта.</td> </tr> <tr> <td>VALUE</td>   
	*  <td>Значение варианта.</td> </tr> <tr> <td>SORT</td>     <td>Индекс сортировки.</td>
	* </tr> <tr> <td>DESCRIPTION</td>     <td>Описание варианта значения свойства
	...
	*/
	...
	/**
	* <p>Метод добавляет новый вариант для выбора значения в свойствах типа переключатель (RADIO) и списки (SELECT, MULTISELECT). Нестатический метод.</p>
	*
	*
