...
class CSaleUserTransact extends CAllSaleUserTransact
{
	...
	/**
	* <p>Метод возвращает параметры транзакции с кодом ID. Нестатический метод.</p>
	*
	*
	...
	* списание денег со счета;</li> 	<li> <b>DESCRIPTION</b> - описание;</li> 	<li>
	...
	* <b>TIMESTAMP_X</b> - дата последнего изменения записи;</li> 	<li> <b>TRANSACT_DATE</b> -
	* дата транзакции.</li> </ul><br><br>
	*
	* @static
	...
	*/
	...
	/**
	* <p>Метод возвращает результат выборки записей транзакций в соответствии со своими параметрами. Нестатический метод.</p>
	*
	*
	...
	* "название_поляX" может стоять любое поле 		транзакций.<br><br> 		Пример
	...
	* "название_поля<i>N</i>" может стоять любое поле 		транзакций. В
	...
	* пользователя;</li> 	<li> <b>USER_NAME</b> - имя пользователя;</li> 	<li>
	* <b>USER_LAST_NAME</b> - фамилия пользователя;</li> 	<li> <b>USER_EMAIL</b> - E-Mail
	* пользователя.</li> </ul><p>Если в качестве параметра arGroupBy передается
	...
	*/
	...
	/**
	* <p>Метод добавляет новую транзакцию с параметрами из массива arFields. Нестатический метод.</p>
	*
	*
	* @param array $arFields  Ассоциативный массив параметров новой транзакции с ключами: 		<ul>
	* <li> <b>USER_ID</b> - код пользователя;</li> 			<li> <b>AMOUNT</b> - сумма;</li> 			<li>
	* <b>CURRENCY</b> - валюта суммы;</li> 			<li> <b>DEBIT</b> - "Y", если занесение денег на
	* счет, и 				"N", если списание денег со счета;</li> 			<li> <b>DESCRIPTION</b> -
	* описание;</li> 			<li> <b>ORDER_ID</b> - код заказа, если транзакция относится
	* к заказу;</li> 			<li> <b>EMPLOYEE_ID</b> - код пользователя, осуществившего
	...
	*/
	...
	/**
	* <p>Метод изменяет параметры транзакции в соответствии с параметрами из массива arFields. Нестатический метод.</p>
	*
	*
	* @param mixed $intID  Код изменяемой транзакции.
	*
	* @param array $arFields  Ассоциативный массив новых параметров новой транзакции с
	* ключами: 		<ul> <li> <b> USER_ID</b> - код пользователя;</li> 			<li> <b> AMOUNT</b> -
	* сумма;</li> 			<li> <b> CURRENCY</b> - валюта суммы;</li> 			<li> <b> DEBIT</b> - "Y", если
	* занесение денег на счет, и 				"N", если списание денег со счета;</li>
	* 			<li> <b> DESCRIPTION</b> - описание;</li> 			<li> <b> ORDER_ID</b> - код заказа, если
	* транзакция относится к заказу;</li> 			<li> <b> EMPLOYEE_ID</b> - код
	* пользователя, осуществившего транзакцию;</li> 			<li> <b> TRANSACT_DATE</b> -
	* дата транзакции.</li> 		</ul>
	*
