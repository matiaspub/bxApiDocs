...
class CSaleUserTransact extends CAllSaleUserTransact
{
	...
	/**
	 * <p>Метод возвращает параметры транзакции с кодом ID.</p>
	 *
	 *
	 *
	 *
	...
	/**
	 * <p>Функция возвращает результат выборки записей транзакций в соответствии со своими параметрами.</p>
	 *
	 *
	 *
	 *
	...
	/**
	 * <p>Метод добавляет новую транзакцию с параметрами из массива arFields.</p>
	 *
	 *
	 *
	 *
	...
	/**
	 * <p>Метод изменяет параметры транзакции в соответствии с параметрами из массива arFields.</p>
	 *
	 *
	 *
	 *
