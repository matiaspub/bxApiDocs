...
class CSaleOrderPropsGroup extends CAllSaleOrderPropsGroup
{
	...
	* фильтра: 		<pre class="syntax">array("!PERSON_TYPE_ID" =&gt; 1)</pre> 		Этот фильтр означает
	* "выбрать все записи, в которых значение в поле PERSON_TYPE_ID (код типа
	* плательщика) не равно 1".<br><br> 	Значение по умолчанию - пустой
	...
	*    <td>Код группы заказов.</td> </tr> <tr> <td>PERSON_TYPE_ID</td>     <td>Тип
	* плательщика.</td>   </tr> <tr> <td>NAME</td>     <td>Название группы.</td>   </tr> <tr>
	* <td>SORT</td>     <td>Индекс сортировки.</td>   </tr> </table><p>Если в качестве
	...
	*/
	...
	/**
	* <p>Метод добавляет новую группу свойств заказа. Группа используется только для группировки свойств. Нестатический метод.</p>
	*
	*
