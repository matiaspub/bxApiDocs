...
class CSaleLocation extends CAllSaleLocation
{
	 ...
	 * в поле COUNTRY_ID (код страны) равно 15".<br><br> Значение по умолчанию -
	 * пустой массив array() - означает, что результат отфильтрован не
	 * будет.
	 *
	 *
	 *
	 * @param array $arGroupBy = false Массив полей, по которым группируются записи местоположений.
	 ...
	 * </tr> <tr> <td>COUNTRY_ID</td> <td>Код страны.</td> </tr> <tr> <td>CITY_ID</td> <td>Код города.</td>
	 ...
	 * <td>COUNTRY_NAME_LANG</td> <td>Языкозависимое название страны.</td> </tr> <tr>
	 * <td>CITY_NAME_ORIG</td> <td>Языконезависимое название города.</td> </tr> <tr>
	 * <td>CITY_SHORT_NAME</td> <td>Языконезависимое короткое название города.</td> </tr>
	 * <tr> <td>CITY_NAME_LANG</td> <td>Языкозависимое название города.</td> </tr> <tr>
	 ...
	 * установлено. Иначе - языконезависимое название города.</td> </tr>
	 ...
	 * <td>CITY_ID</td> <td>Код города.</td> </tr> <tr> <td>SORT</td> <td>Индекс сортировки.</td>
	 * </tr> <tr> <td>COUNTRY_NAME_ORIG</td> <td>Языконезависимое название страны.</td> </tr>
	 * <tr> <td>COUNTRY_SHORT_NAME</td> <td>Языконезависимое сокращенное название
	 * страны.</td> </tr> <tr> <td>COUNTRY_NAME_LANG</td> <td>Языкозависимое название
	 * страны.</td> </tr> <tr> <td>CITY_NAME_ORIG</td> <td>Языконезависимое название
	 * города.</td> </tr> <tr> <td>CITY_SHORT_NAME</td> <td>Языконезависимое сокращенное
	 * название города.</td> </tr> <tr> <td>CITY_NAME_LANG</td> <td>Языкозависимое название
	 * города.</td> </tr> <tr> <td>COUNTRY_NAME</td> <td>Языкозависимое название страны,
	 * если оно есть. Иначе - языконезависимое название страны.</td> </tr> <tr>
	 * <td>CITY_NAME</td> <td>Языкозависимое название города, если оно есть. Иначе
	 * - языконезависимое название города.</td> </tr> </table><p>  </p><a name="examples"></a>
	 *
	 *
	 * <h4>Example</h4> 
	 * <pre>
	 ...
	 * языконезависимое название страны.</td> </tr> </table><p> </p>
	 *
	 * @static
