...
class CSaleOrderUserProps extends CAllSaleOrderUserProps
{
	...
	/**
	* <p>Метод возвращает результат выборки записей из профилей покупателя в соответствии со своими параметрами. Нестатический метод.</p>
	*
	*
	...
	* фильтра: 		<pre class="syntax">array("~NAME" =&gt; "John*")</pre> 		Этот фильтр означает
	* "выбрать все записи, в которых значение в поле NAME (название
	* профиля) начинается с John".<br><br> 	Значение по умолчанию - пустой
	* массив array() - означает, что результат отфильтрован не будет.<br><br><div
	...
	*/
	...
	/**
	* <p>Метод сохраняет новый профиль покупателя с параметрами из массива arFields. Нестатический метод.</p>
	*
	*
