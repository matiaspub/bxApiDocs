...
class CPosting extends CPostingGeneral
{
	...
	/**
	* <p>Метод возвращает список выпусков по фильтру. Метод нестатический.</p>
	*
	*
	...
	* принимать значение:          <ul> <li> <b>ID</b> - идентификатор выпуска;</li>     
	*     	           <li> <b>TIMESTAMP</b> - дата изменения;</li>          	           <li> <b>SUBJECT</b> -
	* тема письма;</li>          	           <li> <b>BODY_TYPE</b> - тип текста;</li>          	          
	* <li> <b>STATUS</b> - статус выпуска;</li>          	           <li> <b>DATE_SENT</b> - дата
	* отправки выпуска;</li>          	           <li> <b>AUTO_SEND_TIME</b> - время
	* автоматической отправки выпуска;</li>          </ul>        	Направление
	* сортировки может принимать значение:          <ul> <li> <b>ASC</b> - по
	* возрастанию;</li>          	           <li> <b>DESC</b> - по убыванию.</li>          </ul>       
	* 	Пример: 	         <pre class="syntax"><code>array("STATUS"=&gt;"ASC",             <br>           
	...
	* принимать значение:          <ul> <li> <b>ID</b> - идентификатор выпуска
	* (возможны сложные условия);</li>          	           <li> <b>TIMESTAMP_1</b> - дата
	* изменения (начало периода);</li>          	           <li> <b>TIMESTAMP_2</b> - дата
	* изменения (конец периода);</li>          	           <li> <b>DATE_SENT_1</b> - дата
	* отправки (начало периода);</li>          	           <li> <b>DATE_SENT_2</b> - дата
	* отправки (конец периода);</li>          	           <li> <b>AUTO_SEND_TIME_1</b> - дата или
	* время автоматической отправки (начало периода);</li>          	           <li>
	* <b>AUTO_SEND_TIME_2</b> - дата или время автоматической отправки (конец
	* периода);</li>          	           <li> <b>STATUS</b> - статус выпуска строкой
	* (возможны сложные условия);</li>          	           <li> <b>STATUS_ID</b> - статус
	* выпуска символом (возможны сложные условия);</li>          	           <li>
	* <b>SUBJECT</b> - тема письма (возможны сложные условия);</li>          	           <li>
	* <b>FROM</b> - поле "от кого" письма (возможны сложные условия);</li>          	   
	*        <li> <b>TO</b> - кому отправлен выпуск (возможны сложные условия);</li> 
	*         	           <li> <b>BODY_TYPE</b> - тип текста письма;</li>          	           <li> <b>BODY</b>
	* - текст письма (возможны сложные условия);</li>                    <li> <b>RUB_ID</b> -
	* масив идентификаторов рассылок с которыми связан выпуск;            
	* <br> </li>          	           <li> <b>MSG_CHARSET</b> - кодировка в которой был составлен
	* выпуск (точное совпадение).</li>          </ul>        	Пример: 	         <pre
	* class="syntax"><code>array("SUBJECT"=&gt;"test | тест",             <br>           
	* "TO"=&gt;"@bitrixsoft.ru")</code></pre>
	*
	...
	*/
	...
	/**
	* <p>Метод возвращает true при успешной блокировке выпуска и false при не успешной. Используется при автоматической отправке выпусков. Метод статический.</p>
	*
	*
	...
	*/
	...
	/**
	* <p>Метод возвращает true при успешном снятии блокировки выпуска и false при неуспешном. Используется при отправке выпусков. Метод статический.</p>
	*
	*
	* @param mixed $intID  Идентификатор выпуска.
	*
