...
class _CEventsSubscribe {
	/**
	 * Событие "BeforePostingSendMail" вызывается перед отправкой выпуска из функции <a href="http://dev.1c-bitrix.ru/api_help/subscribe/classes/cposting/cpostingsendmessage.php">CPosting::SendMessage</a>.
	 *
	 *
	 *
	 *
