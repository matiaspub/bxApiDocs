...
class CSaleOrderProps extends CAllSaleOrderProps
{
	 ...
	 * заказов.<br><br> Пример фильтра: <pre class="syntax">array("REQUIED" =&gt; "Y")</pre> Этот
	 * фильтр означает "выбрать все записи, в которых значение в поле
	 * REQUIED (обязательно для заполнения) равно Y".<br><br> Значение по
	 ...
	 * </tr> <tr> <td>CODE</td> <td>Мнемонический код свойства.</td> </tr> </table><p>Если в
	 ...
	 * свойства.</li> <li> <b>IS_FILTERED</b> - свойство доступно в фильтре по
	 * заказам. С версии 10.0.</li> <li> <b>IS_ZIP</b> - использовать как почтовый
	 * индекс. С версии 10.0.</li> <li> <b>UTIL</b> - позволяет использовать свойство
	 * только в административной части. С версии 11.0.</li> </ul>
	 *
	 *
	 *
