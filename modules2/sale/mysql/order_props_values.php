...
class CSaleOrderPropsValue extends CAllSaleOrderPropsValue
{
	 ...
	 * </tr> <tr> <td>ID</td> <td>Код значения свойства заказа.</td> </tr> <tr> <td>ORDER_ID</td>
	 * <td>Код заказа.</td> </tr> <tr> <td>ORDER_PROPS_ID</td> <td>Код свойства.</td> </tr> <tr>
	 * <td>NAME</td> <td>Название свойства.</td> </tr> <tr> <td>VALUE</td> <td>Значение
	 * свойства.</td> </tr> <tr> <td>CODE</td> <td>Мнемонический код свойства.</td> </tr>
	 ...
	 * это значение в качестве имени покупателя.</td> </tr>
	 * </table><p>Результирующий набор отсортирован последовательно по
	 * индексу сортировки группы свойств заказа, названию группы
	 * свойств заказа, индексу сортировки свойства заказа, названию
	 * свойства заказа.</p><a name="examples"></a>
	 *
	 *
	 * <h4>Example</h4> 
	 * <pre>
