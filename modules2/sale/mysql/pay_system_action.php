...
class CSalePaySystemAction extends CAllSalePaySystemAction
{
	...
	/**
	 * <p>Функция возвращает результат выборки записей из обработчиков платежных систем в соответствии со своими параметрами. </p>
	 *
	 *
	 *
	 *
	 ...
	 * <td>PAY_SYSTEM_ID</td> <td>Код платежной системы.</td> </tr> <tr> <td>PERSON_TYPE_ID</td> <td>Код
	 * типа плательщика.</td> </tr> <tr> <td>NAME</td> <td>Название платежной
	 * системы.</td> </tr> <tr> <td>ACTION_FILE</td> <td>Скрипт платежной системы.</td> </tr> <tr>
	 * <td>RESULT_FILE</td> <td>Скрипт получения результатов.</td> </tr> <tr> <td>NEW_WINDOW</td>
	 * <td>Флаг (Y/N) открывать ли скрипт платежной системы в новом окне.</td>
	 * </tr> <tr> <td>PARAMS</td> <td>Параметры вызова обработчика.</td> </tr> <tr>
	 * <td>HAVE_PAYMENT</td> <td>Есть вариант обработчика для работы после
	 * оформления заказа.</td> </tr> <tr> <td>HAVE_ACTION</td> <td>Есть вариант
	 * обработчика для мгновенного списания денег.</td> </tr> <tr> <td>HAVE_RESULT</td>
	 * <td>Есть скрипт запроса результатов.</td> </tr> <tr> <td>HAVE_PREPAY</td> <td>Есть
	 * вариант обработчика для работы во время оформления заказа.</td> </tr>
	 * <tr> <td>PS_LID</td> <td>Сайт платежной системы.</td> </tr> <tr> <td>PS_CURRENCY</td>
	 * <td>Валюта платежной системы.</td> </tr> <tr> <td>PS_NAME</td> <td>Название
	 * платежной системы.</td> </tr> <tr> <td>PS_ACTIVE</td> <td>Активность платежной
	 * системы.</td> </tr> <tr> <td>PS_SORT</td> <td>Индекс сортировки платежной
	 * системы.</td> </tr> <tr> <td>PS_DESCRIPTION</td> <td>Описание платежной системы.</td>
	 * </tr> <tr> <td>PT_LID</td> <td>Сайт типа плательщика.</td> </tr> <tr> <td>PT_NAME</td>
	...
	public static function GetList($arOrder = array(), $arFilter = array(), $arGroupBy = false, $arNavStartParams = false, $arSelectFields = array())
	{
		...
		if (count($arSelectFields) <= 0)
			$arSelectFields = array("ID", "PAY_SYSTEM_ID", "PERSON_TYPE_ID", "NAME", "ACTION_FILE", "RESULT_FILE", "NEW_WINDOW", "PARAMS", "ENCODING", "LOGOTIP");
	...
	/**
	 * <p>Метод добавляет новый обработчик платежной системы на основании параметров из массива arFields. </p>
	 *
	 *
	 *
	 *
	...
	/**
	 * <p>Функция обновляет параметры обработчика с кодом ID платежной системы в соответствии с массивом arFields. </p>
	 *
	 *
	 *
	 *
