...
class CStudent
{
	...
	/**
	 * <p>Возвращает возвращает учётную запись студента по коду пользователя USER_ID.</p>
	 *
	 *
	 *
	 *
	 ...
	 * фильтруется по убыванию коду пользователя.
	 *
	 *
	 *
	 ...
	 * поля может указать тип фильтрации: <ul> <li>"!" - не равно </li> <li>"&lt;" -
