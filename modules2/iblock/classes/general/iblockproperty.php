...
class CAllIBlockProperty
{
	 ...
	 * свойства; </li> <li> <b>SEARCHABLE</b> - по признаку участия значения свойства
	 * в поиске (Y|N); </li> <li> <b>FILTRABLE</b> - по признаку участия свойства в
	 * фильре на странице списка элементов (Y|N);</li> <li> <b>VERSION</b> - по флагу
	 * хранения значений свойств элементов инфоблока;</li> <li> <b>MIN_PERMISSION</b>
	 * - фильтр по правам доступа, по умолчанию принимает <i>R</i> (уровень
	 * доступа <i>Чтение</i>);</li> <li> <b>CHECK_PERMISSIONS</b> - если установлено
	 * значение "N", то проверки прав не происходит; <br> </li> <li> <b>IBLOCK_ID</b> - по
